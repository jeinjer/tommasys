<template>
  <header class="nav-main-wrapper" id="nav">
    <!-- Desktop Header -->
    <div class="nav-desktop">
      <div class="nav-desktop-inner">
        ...
        <div class="nav-right">
          <a href="#contacto" class="nav-cta-glass">
            Contacto
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="nav-cta-arrow">
        ...
        >
          ...
          <div class="sidebar-footer">
            <div class="sidebar-socials">
              ...
              <a href="https://instagram.com/tommasys.ar" target="_blank" rel="noopener noreferrer" class="sidebar-social" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
